...
function openPopup(participation_id) {
  let element = document.getElementById(participation_id);
  if (element) {
...
function closePopup(participation_id) {
  let element = document.getElementById(participation_id);
  if (element) {
