                    ...
                    <form class="form" action="<?php echo URLROOT; ?>/events/add" method="post"
                        ...
                        <div class="column">
                            <div class="input-box">
                                ...
                                <input type="text" name="organized_by" value="" id="" placeholder="Enter the organization entity">
                        ...
                        <div class="column">
                            ...
                            <div class="input-box">
                                ...
                                <input type="tel" name="contact_number" value="" id="" placeholder="Enter the Contact Number">
