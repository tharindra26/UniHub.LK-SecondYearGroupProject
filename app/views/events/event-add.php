                ...
                <div class="column">
                    <div class="input-box">
                        ...
                        <div class="select-box">
                            <select name="university" id="selection" value="<?php echo $data['university'] ?>">
                                <option hidden <?php if (empty($data['university'])) echo 'selected'; ?>>University</option>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="organized_by" value="<?php echo $data['organized_by'] ?>" id="" placeholder="Enter full name">
                        ...
                        <div class="input-box ">
                            ...
                            <div class="select-box category">
                                <select name="category" value="<?php echo $data['category'] ?>" id="selection">
                                    ...
                                    <option value="Musical Show" <?php if ($data['category'] == 'Musical Show') echo 'selected'; ?>>Musical Show</option>
