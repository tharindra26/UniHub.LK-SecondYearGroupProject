...
<link rel="stylesheet" href="<?php echo URLROOT ?>/css/organizations/editCategories_style.css">

<div class="container">
    <div class="inner-container">
        <div class="title-text">
            <p>Change Organization Categories</p>
        </div>
            ...
            <div class="left-box">
                <div class="users" id="filter-table">
                    <table class="user-table">
                        ...
                        <tbody>
                            <?php if (!empty($data['organizationCategories'][0]->category_record_id)): ?>
                                <?php foreach ($data['organizationCategories'] as $category):
                                    ...
                                    <tr>
                                        ...
                                        <td id="action">
                                            <a href="#" class="update"
                                                onclick="openPopup('delete-popup-<?php echo $category->category_record_id ?>')">
                                                <i class="fa-solid fa-trash-can"></i></a>
                                            <!-- popupModal -->

                                            <span class="overlay"></span>
                                            <div class="modal-box" id="delete-popup-<?php echo $category->category_record_id ?>">
                                                ...
                                                <div class="buttons">
                                                    <button class="close-btn"
                                                        onclick="deleteCategory(<?php echo $category->category_record_id ?>)">Ok,Delete</button>
                                                </div>
                                            </div>
                            ...
                            <div class="input-box ">
                                ...
                                <div class="select-box category">
                                    ...
                                    <select name="categories[]" id="selection">
                                        ...
                                        <?php if (!empty($data['allCategories'][0]->category_id)): ?>
...
<script>
    ...
    function deleteCategory(categoryId) {
        ...
        $.ajax({
            type: 'POST',
            url: URLROOT + '/organizations/deleteOrganizationCategory', // Replace with the URL of your server-side script
            data: {
    ...
    function addCategory() {
        ...
        if (selectedCategory) {
            ...
            $.ajax({
                type: 'POST',
                url: URLROOT + '/organizations/addOrganizationCategory', // Replace 'your-backend-url' with the actual backend URL
                data: {
...
<script src="<?php echo URLROOT ?>/js/organizations/editCategories.js"></script>
