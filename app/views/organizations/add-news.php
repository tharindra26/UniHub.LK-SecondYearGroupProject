...
<div class="container">
    <div class="inner-container">
        <div class="top-part">
            <header>Add Organization News</header>
        </div>
        <div class="bottom-part">
            <div class="bottom-left">
                <div class="add-event-form">
                    ...
                    <form class="form"
                        action="<?php echo URLROOT; ?>/organizations/addNews/<?php echo $data['organization_id'] ?>"
                        ...
                        <button class="submit-btn" type="submit">Submit News</button>
                    </form>
                </div>
            </div>
