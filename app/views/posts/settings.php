...
<link rel="stylesheet" href="<?php echo URLROOT ?>/css/posts/settings_style.css">
    ...
    <div class="inner-container">
        ...
        <div class="bottom-part">
            <div class="options-box">
                ...
                <a href="<?php echo URLROOT ?>/posts/updatePost/<?php echo $data['id'] ?>"
                    class="option-link">
                    <div class="option">
                        <div class="option-icon">
                            <i class="fa-solid fa-wrench"></i>
                        </div>
                        <div class="option-text">Update Post</div>
                    </div>
                </a>
                ...
                <a href="#" class="option-link " onclick="openPopup('delete-popup-<?php echo $data['id'] ?>')">
                    <div class="option delete-option" >
                        ...
                        <div class="option-text">Delete Post</div>
                    </div>
                </a>
                <!-- popupModal -->
                ...
                <div class="modal-box" id="delete-popup-<?php echo $data['id'] ?>">
                    ...
                    <div class="buttons">
                        <button class="close-btn"
                            onclick="deletePost(<?php echo $data['id'] ?>)">Ok,Delete</button>
                    </div>
                </div>
                <!-- popupModal -->
...
<script>
    ...
    function deletePost(postId) {
        ...
        $.ajax({
            type: 'POST',
            url: URLROOT + '/posts/deletePost', // Replace with the URL of your server-side script
            data: {
                postId: postId
            ...
            success: function (response) {
                if (response == true) {
                    ...
                    closePopup('delete-popup-' + postId);
                    setTimeout(function () {
                        window.location.href = URLROOT+'/posts/index';
...
<script src="<?php echo URLROOT ?>/js/posts/settings.js"></script>
