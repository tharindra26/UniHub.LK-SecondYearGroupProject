        ...
        <div class="bottom-part">
            ...
            <div class="left-box">
                <div class="form-outer-box">
                    ...
                    <form class="form" action="<?php echo URLROOT; ?>/posts/updatePost/<?php echo $data['post_id'] ?>" method="post"
                                ...
                                <div class="input-box ">
                                    ...
                                    <div class="select-box category">
                                        ...
                                        <select name="categories[]" id="selection" multiple>
                                            ...
                                            <?php
                                            // Ensure $data['categories'] is a string or array
                                            if (is_string($data['categories'])) {
                                                $data['categories'] = explode(',', $data['categories']); // Convert string to array
                                            }

                                            $categories = array('Blogs', 'Research', 'Kuppi'); // Assuming these are your categories
                                            
                                            foreach ($categories as $category) {
                                                $selected = (in_array($category, $data['categories'])) ? 'selected' : '';
