...
<link rel="stylesheet" href="<?php echo URLROOT ?>/css/users/undergraduate/editProfileImage_style.css">
        ...
        <div class="bottom-part">
            ...
            <div class="left-box">
                <div class="form-outer-box">
                    ...
                    <form class="form" action="<?php echo URLROOT; ?>/users/editProfileImage/<?php echo $data['id'] ?>" method="post"
                        enctype="multipart/form-data">
                        <h3>Profile Image</h3>
                        <div class="profile-img-box">
                            <img src="<?php echo URLROOT ?>/img/users/users_profile_images/<?php echo $data['profile_image'] ?>"
                                alt="">
                        </div>
                        ...
                        <div class="cover-img-box">
                            <img src="<?php echo URLROOT ?>/img/users/users_cover_images/<?php echo $data['cover_image'] ?>"
                                alt="">
                        </div>
