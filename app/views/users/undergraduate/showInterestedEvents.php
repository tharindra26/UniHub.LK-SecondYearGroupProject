                                    ...
                                    <div class="material">
                                        <a href="<?php echo URLROOT ?>/events/show/<?php echo $interestedEvents->id ?>">
                                            <div class="material-img">
                                                ...
                                                <img src="<?php echo URLROOT ?>/img/events/events_profile_images/<?php echo $interestedEvents->event_profile_image ?>"
                                            ...
                                            <div class="material-content">
                                                ...
                                                <div class="date-vennue">
                                                    ...
                                                    <div class="tab-venue-section">
                                                        ...
                                                        <?php echo $interestedEvents->venue ?>
                                                    </div>
                                                </div>
                                                <p>
                                                    <?php
                                        ...
                                        <div class="edu-btn">
                                            <a href="#" class="button"
                                                onclick="openPopup('<?php echo $participation_id; ?>')"><i
                                            ...
                                            <div class="modal-box" id="<?php echo $participation_id; ?>">
                                                ...
                                                <div class="btn">
                                                    <button class="close-btn"
                                                        onclick="confirmDelete('<?php echo $participation_id ?>')">Delete</button>
                                                    <button class="close-btn"
                                                        onclick="closePopup('<?php echo $participation_id ?>')">Cancel</button>
                                                </div>
                                            </div>
