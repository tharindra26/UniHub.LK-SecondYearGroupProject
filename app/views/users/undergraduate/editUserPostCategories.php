            ...
            <div class="left-box">
                <div class="users" id="filter-table">
                    <table class="user-table">
                        ...
                        <tbody>
                            <?php if (!empty($data['userPostCategories'][0]->id)): ?>
                                <?php foreach ($data['userPostCategories'] as $category):
                                    if (empty($category)):
                                        break;
                                    endif; ?>
                            ...
                            <div class="input-box ">
                                ...
                                <div class="select-box category">
                                    ...
                                    <select name="categories[]" id="selection">
                                        ...
                                        <?php if (!empty($data['postCategories'][0]->category_id)): ?>
...
<script>
    ...
    function deleteCategory(categoryId) {
        ...
        $.ajax({
            type: 'POST',
            url: URLROOT + '/users/deletePostInterestCategory', // Replace with the URL of your server-side script
            data: {
    ...
    function addCategory() {
        ...
        if (selectedCategory) {
            ...
            $.ajax({
                type: 'POST',
                url: URLROOT + '/users/addPostInterestCategory', // Replace 'your-backend-url' with the actual backend URL
                data: {
